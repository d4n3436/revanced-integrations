...
/*
* from v0.101.33
* https://github.com/inotia00/revanced-integrations/commit/3ef810f3e43a9898aa29fa82ff117ed82cc06375
*/
public class ProtobufSpoofPatch {
    ...
    public static void switchProtobufSpoof() {
        try {
            ...
            if (SettingsEnum.ENABLE_PROTOBUF_SPOOF.getBoolean() || getBoolean(context, YOUTUBE, PREFERENCE_KEY, false)) return;
